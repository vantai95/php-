        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-8">
                    <div class="banner">
                        <img src="{{url('images/image_list/'.$event ->image)}}" alt="" title="">
                    </div>
                    <div class="event_time">
                        <div class="row event_time_content">
                            <div class="col-6 event_time_date"> <img src="/b2c-assets/img/promo-clock.png"
                                    alt="clock" title="clock">
                                <span class="date">{{ $event->created_at->toFormattedDateString() }}</span></div>
                            <div class="col-6 text-right event_time_social">
                                <span><a href="#"><img src="/b2c-assets/img/icon-facebook.png" alt=""
                                            title=""></a></span>
                                <span><a href="#"><img src="/b2c-assets/img/icon-google-plus.png" alt=""
                                            title=""></a></span>
                                <span><a href="#"><img src="/b2c-assets/img/icon-pinterest.png" alt=""
                                            title=""></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="related-new">
                        <div class="related-new-content">
                            <div class="related-new-title">
                                @lang('b2c.event.detail.title.related_news')
                            </div>
                            @foreach ($news as $item)
                            <div class="related-new-body">
                                <a href="{{url('news/detail/'.$item ->id)}}"><img class="img-related-new"
                                        src="{{\App\Services\ImageService::imageUrl($item->image) }}" alt="" title=""></a>
                                <div class="date-clock">
                                    <img cl#customerServiceModalass="img-clock" src="/b2c-assets/img/promo-clock.png" alt=""
                                        title="">
            ...
            <div class="related-treatment">
                <div class="row">
                    <div class="col-12 text-center mb-2 mb-sm-4">
                        <div class="title">@lang('b2c.event.detail.title.related_treatments')</div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12 col-sm-4 text-center">
                        <div class="content">
                            ...
                            <div class="button"><a
                                    href="{{url('services/detail/'.$item ->id)}}"><span>@lang('b2c.event.detail.text.view_more')</span></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
