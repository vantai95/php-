...
@section('content')
    ...
    <div class="m-content">
        <div class="m-portlet">
            <!--begin::Form-->
        {!! Form::model($promotion, ['method' => 'PATCH','url' => ['/admin/promotions', $promotion->id], 'class' => 'm-form m-form--fit m-form--label-align-right', 'id' => 'submitForm', 'files' => true]) !!}
        @include ('admin.promotions.form', ['submitButtonText' => @trans('admin.promotions.buttons.update')])
        {!! Form::close() !!}
        <!--end::Form-->
        </div>
    </div>
