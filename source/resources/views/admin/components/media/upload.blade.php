<div id="{{$name}}_upload" class="tab-pane active">
    <div class="control-group">
        <label class="control-label">@lang('admin.media_modal.text.upload_img')</label>
        <div class="col-sm-12">
            <div class="row m-dropzone dropzone m-dropzone--primary" id="{{$name}}-dropzone">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary"
                    id="{{$name}}_upload_image">@lang('admin.media_modal.button.upload')</button>
        </div>
    </div>
</div>
