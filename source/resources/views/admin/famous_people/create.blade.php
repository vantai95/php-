...
@section('content')
    ...
    <div class="m-content">
        <div class="m-portlet">
            <!--begin::Form-->
            {!! Form::open(['url' => '/admin/famous-people', 'class' => 'm-form m-form--fit m-form--label-align-right', 'files' => true,'id' => 'submitForm']) !!}
            @include ('admin.famous_people.form',['submitButtonText' =>  trans('admin.buttons.create')])
            {!! Form::close() !!}
            <!--end::Form-->
        </div>
    </div>
