...
<div class="m-content">
    <div class="m-portlet">
        {!! Form::model($famousPeople, [ 'method' => 'PATCH', 'url' => ['/admin/famous-people', $famousPeople->id], 'class' => 'm-form m-form--fit m-form--label-align-right', 'files' => true,'id' => 'submitForm']) !!}
        @include ('admin.famous_people.form', ['submitButtonText' => trans('admin.buttons.update')])
        {!! Form::close() !!}
    </div>
</div>
@endsection
        ...
        var DropzoneDemo = {
            init: function () {
                Dropzone.options.mDropzoneTwo = {
                    ...
                    'url': "{{ url('/admin/famous-people/upload') }}",
                    "headers":
                        {
                            'X-CSRF-TOKEN': token
                        },
