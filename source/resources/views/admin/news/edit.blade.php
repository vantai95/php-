...
@section('content')
    ...
    <div class="m-content">
        <div class="m-portlet">
            <!--begin::Form-->
        {!! Form::model($news, ['method' => 'PATCH','url' => ['/admin/news', $news->id], 'class' => 'm-form m-form--fit m-form--label-align-right', 'id' => 'submitForm', 'files' => true]) !!}
        @include ('admin.news.form', ['submitButtonText' => @trans('admin.news.buttons.update')])
        {!! Form::close() !!}
        <!--end::Form-->
        </div>
    </div>
