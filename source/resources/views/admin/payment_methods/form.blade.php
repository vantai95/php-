<div class="m-portlet__body m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
    <div class="form-group m-form__group row">
        <div class="col-lg-4 {{ $errors->has('active') ? 'has-danger' : ''}}">
            <label for="active" class="col-form-label col-sm-12">@lang('admin.payment_methods.forms.status')</label>
            <div class="col-sm-12">
                <div class="m-checkbox-inline">
                    <label class="m-checkbox">
                        {!! Form::checkbox('active', 1, isset($payment_method) ? $payment_method->active : true, ['class' => 'form-control ','name'=>'active','id'=>'active']) !!}
                        @lang('admin.payment_methods.forms.active')
                        <span></span>
                    </label>
                </div>
    ...
    <div class="form-group m-form__group row">
        <div class="col-lg-4 {{ $errors->has('name_en') ? 'has-danger' : ''}}">
            <label for="name_en" class="col-form-label col-sm-12">@lang('admin.payment_methods.forms.name_en')
        ...
        <div class="col-lg-4 {{ $errors->has('name_vi') ? 'has-danger' : ''}}">
            <label for="name_vi" class="col-form-label col-sm-12">@lang('admin.payment_methods.forms.name_vi')</label>
            <div class="col-sm-12">
        ...
        <div class="col-lg-4 {{ $errors->has('name_ja') ? 'has-danger' : ''}}">
            <label for="name_ja" class="col-form-label col-sm-12">@lang('admin.payment_methods.forms.name_ja')</label>
            <div class="col-sm-12">
    ...
    <div class="form-group m-form__group row">
        <div class="col-lg-4 {{ $errors->has('description_en') ? 'has-danger' : ''}}">
            <label for="description_en" class="col-form-label col-sm-12">@lang('admin.payment_methods.forms.description_en')
                <span class="text-danger">*</span>
            </label>
            <div class="col-sm-12">
        ...
        <div class="col-lg-4 {{ $errors->has('description_vi') ? 'has-danger' : ''}}">
            <label for="description_vi" class="col-form-label col-sm-12">@lang('admin.payment_methods.forms.description_vi')</label>
            <div class="col-sm-12">
        ...
        <div class="col-lg-4 {{ $errors->has('description_ja') ? 'has-danger' : ''}}">
            <label for="description_ja" class="col-form-label col-sm-12">@lang('admin.payment_methods.forms.description_ja')</label>
            <div class="col-sm-12">
    ...
    <div class="m-form__actions m-form__actions">
        <div class="row">
            <div class="col-lg-9 ml-lg-auto">
                {!! Form::submit(isset($submitButtonText) ? $submitButtonText : trans('admin.payment_methods.buttons.create'), ['class' => 'btn btn-success', 'id' => 'submitButton']) !!}
                <a href="{{url('admin/events')}}" class="btn btn-secondary">
                    @lang('admin.payment_methods.buttons.cancel')
                </a>
            </div>
        </div>
    </div>
