...
@section('content')
    ...
    <div class="m-content">
        <div class="m-portlet">
            <!--begin::Form-->
        {!! Form::model($aboutUs, [ 'method' => 'PATCH', 'url' => ['/admin/about-us', $aboutUs->id], 'class' => 'm-form m-form--fit m-form--label-align-right', 'files' => true,'id' => 'submitForm']) !!}
        @include ('admin.abouts_us.form', ['submitButtonText' => trans('admin.buttons.update')])
        {!! Form::close() !!}
        <!--end::Form-->
        </div>
    </div>
